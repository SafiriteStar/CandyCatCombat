...
async function createCellButton(classList, value, onclick, catName, catImagePath) {
...
async function createTeamCell(cat, baseCats, canRemove) {
    let catImagePaths = [
        './assets/VanillaCat/Vanilla_Cat_Base.png',
        './assets/CandyCornCat/Candy_Corn_Cat_Base.png',
        './assets/MawbreakerCat/Mawbreaker_Cat_Base.png',
        './assets/GumCat/Gum_Cat_Base.png',
        './assets/PopCandyCat/Pop_Candy_Cat_Base.png',
        './assets/CaramelCat/Caramel_Cat_Base.png',
        './assets/ChocoDairyMilkCat/Choco_Dairy_Milk_Cat_Base.png',
    ];
...
async function createAddCatCell(baseCats) {
    let catImagePaths = [
        './assets/VanillaCat/Vanilla_Cat_Base.png',
        './assets/CandyCornCat/Candy_Corn_Cat_Base.png',
        './assets/MawbreakerCat/Mawbreaker_Cat_Base.png',
...
async function createTeamDropDown(team, baseCats) {
    ...
    for (let i = 0; i < team.length; i++) {
        ...
        let catCell = await createTeamCell(team[i], baseCats);
    ...
    for (let i = 0; i < 6 - team.length; i++) {
        let addCatCell = await createAddCatCell(baseCats);
